...
def create_connection():
    return pymysql.connect(
        # host="localhost"                    is used when we try to run the application locally
        host="host.docker.internal",        # is used when we try to run the application after containerizing
        user="root",
        password="Tech_Pass@robi",
        database="userinfo",
    )
